...
- **Think at high effort by default; reserve deepest reasoning for irreversible/security-critical work** (frontmatter `effort: high` — Opus 4.8 이후 적용. 중대 비가역 결정은 마스터가 호출 시 xhigh~max로 올린다). 비가역적 결정은 후일 큰 비용을 만든다. 표면 추론 금지.
