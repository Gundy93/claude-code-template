...
- 모델별 비용 비율(2026년 7월 기준): Haiku 4.5 ($1/$5) : Sonnet 5 ($3/$15, 2026-08-31까지 인트로 $2/$10) : Opus 4.8 ($5/$25, 4.7과 동일). Opus 4.8·Sonnet 5 기본 effort는 high(Sonnet 5는 4.6 대비 새 토크나이저로 ~30% 토큰↑, 적응형 추론 기본 ON).
